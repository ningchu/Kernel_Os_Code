...
'''''''''''''''发送结果邮件 
			...
			With oitem
				...
				.Body = "Project : "&PROJECT_NAME.text&vbcrlf&"Node Number : #"&num&vbcrlf&"Test Date : "&logname&vbcrlf&"Test Result : "&result&vbcrlf&"Use_time : "&use_time&vbcrlf&"Fail_reason : "&fail_reason&vbcrlf&"Log And IMG Path : "&VDK_SETUP_PATH.text&"\skins\Linux\Scripts\autotest\"&num&"\"&vbcrlf&vbcrlf&"Attachment is log file and xml file..."&vbcrlf&vbcrlf&"Jenkins地址："&JENKINS_PATH.text&"/"&vbcrlf&vbcrlf&"数据平台地址：http://tjsdelab.spreadtrum.com/autotest.action" '电子邮件内容
